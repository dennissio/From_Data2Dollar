...
# Definition of AirbnbsSpider class
...
class AirbnbsSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        #Dictionary with all the cities and their respective dates
        dictionary = {'palma_e': ['La Palma', '2023-05-20', '2023-05-21', 'ja'], 'palma_n': ['La Palma', '2023-06-10', '2023-06-11', 'nein'], 'barca_e': ['Barcelona', '2023-05-28', '2023-05-29', 'ja'], 'barca_n': ['Barcelona', '2023-06-18', '2023-06-19', 'nein'], 'lyon_e': ['Lyon', '2023-05-20', '2023-05-21', 'ja'], 'lyon_n': ['Lyon', '2023-06-10', '2023-06-11', 'nein'], 
        ...
        for destination in dictionary.keys():
            ...
            while paginator <= max_page:
                ...
                # Iterating over available rooms and extracting the information
